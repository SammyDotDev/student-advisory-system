      ...
      <div className="flex-1 flex items-center justify-center bg-slate-900 p-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="text-slate-400">Enter your account details to continue</p>
          </div>

          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <CardTitle className="text-white">Sign In</CardTitle>
              <CardDescription className="text-slate-400">Access your student advisory portal</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div className="text-center text-white">
          ...
          <div className="max-w-md mx-auto">
            <p className="text-purple-100 text-lg mb-8">
              Your comprehensive platform for academic guidance, course management, and student success.
            </p>
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="bg-white/10 rounded-lg p-4">
                <h4 className="font-semibold mb-2">For Students</h4>
                <p className="text-purple-100">Track progress, view schedules, and connect with advisors</p>
              </div>
              <div className="bg-white/10 rounded-lg p-4">
                <h4 className="font-semibold mb-2">For Advisors</h4>
                <p className="text-purple-100">Manage advisees, schedule meetings, and monitor performance</p>
              </div>
            </div>
          </div>
        </div>
